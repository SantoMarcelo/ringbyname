...
module Env
  ...
  #   if $environment == 'marcelo'
  #     # dev marcelo
  #    return $admin_user = {
  #       username: 'devmarcelo.user1@ringbyname.com',
  #       password: '123456asd'
  #     }
  #   elsif $environment == 'qc'
  #       #dev QC
  #   return  $admin_user = {
...
#     $contact1 = {
#       name: 'Dev Marcel 01 User'
#     }

#     $user1 = {
#       extension: '101',
#       name: 'Dev Marcel 01 User',
#       first_name: 'Dev Marcel 01',
#       last_name: 'User',
...
#     $user2 = {
#       extension: '102',
#       name: 'Dev Marcel 02 User',
#       first_name: 'Dev Marcel 02',
#       last_name: 'User',
...
#     # UAT users
#     $admin_user = {
#       username: 'devuat.user1@ringbyname.com',
#       password: '123456asd'
#     }
